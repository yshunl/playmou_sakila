                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" action="update_data.php" method="POST">
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[4])) . ": "; ?><input type="number" step="0.01" name="<?php echo $columnNames[4]; ?>" value="<?php echo $oldData[4]; ?>"><br><br>
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[5])) . ": "; ?><input type="datetime-local" step="1" name="<?php echo $columnNames[5]; ?>" value="<?php echo str_replace(' ', 'T', $oldData[5]); ?>"><br><br>
