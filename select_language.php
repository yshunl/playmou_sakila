...
<div id="page-content-wrapper">
    ...
    <div class="center hideform">
        ...
        <form action="update_language.php" method="POST">
            <h4><b>Update Language</b></h4><hr>
            Language ID To Update: <input type="number" name="language_id"><br><br>
    ...
    <div class="middle hideform">
        ...
        <form action="delete_language.php" method="POST">
            <h4><b>Delete Language</b></h4><hr>
            Language ID To Delete: <input type="number" name="language_id"><br><br>
    ...
    <div class="mid hideform">
        ...
        <form action="insert_language.php" method="POST">
            <h4><b>Insert New Language</b></h4><hr>
            Name: <input type="text" name="name"><br><br>
    ...
    <table id="_table" width="100%">
        ...
        <?php
            ...
            $sql = "SELECT COUNT(*) AS cntrows FROM language";
            $result = $conn->query($sql);
            $fetchresult = $result->fetch_array();
            $allcount = $fetchresult['cntrows'];
            $sql = "SELECT * FROM language ORDER BY language_id ASC limit $row,".$rowperpage; // Selecting rows
            $result = $conn->query($sql);
