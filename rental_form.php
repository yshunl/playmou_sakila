                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" action="update_data.php" method="POST">
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[1])) . ": "; ?><input type="datetime-local" step="1" name="<?php echo $columnNames[1]; ?>" value="<?php echo str_replace(' ', 'T', $oldData[1]); ?>"><br><br>
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[4])) . ": "; ?><input type="datetime-local" step="1" name="<?php echo $columnNames[4]; ?>" value="<?php echo str_replace(' ', 'T', $oldData[4]); ?>"><br><br>
