...
<div id="page-content-wrapper">
    ...
    <div class="center hideform">
        ...
        <form action="update_film_category.php" method="POST">
            <h4><b>Update Film Category</b></h4><hr>
            Film ID To Update: <input type="number" name="film_id"><br><br>
            Categoty ID: <input type="number" name="category_id"><br><br>
            <input type="submit" name="update" value="Update">
        </form>
    </div>
    <div class="middle hideform">
        <button id="hide" style="float:right;">X</button>        
        <form action="delete_film_category.php" method="POST">
            <h4><b>Delete Film Category</b></h4><hr>
    ...
    <div class="mid hideform">
        ...
        <form action="insert_film_category.php" method="POST">
            <h4><b>Insert New Film Category</b></h4><hr>
    ...
    <table id="_table" width="100%">
        ...
        <?php
            ...
            $sql = "SELECT COUNT(*) AS cntrows FROM film_category";
            $result = $conn->query($sql);
            $fetchresult = $result->fetch_array();
            $allcount = $fetchresult['cntrows'];
            $sql = "SELECT * FROM film_category ORDER BY film_id ASC limit $row,".$rowperpage; // Selecting rows
            $result = $conn->query($sql);
