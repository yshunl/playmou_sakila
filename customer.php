...
<html>
    ...
    <body>
        ...
        <table class="customer" id="<?php echo $tableName ?>">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="insertForm" action="insert_customer.php" method="POST">
                            ...
                            Create Date: <input type="datetime-local" step="1" name="create_date"><br><br>
