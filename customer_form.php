                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="updateForm" action="update_data.php" method="POST">
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[1])) . ": "; ?><input type="number" name="<?php echo $columnNames[1]; ?>" value="<?php echo $oldData[1]; ?>"><br><br>
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[3])) . ": "; ?><input type="text" name="<?php echo $columnNames[3]; ?>" value="<?php echo $oldData[3]; ?>"><br><br>
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[4])) . ": "; ?><input type="text" name="<?php echo $columnNames[4]; ?>" value="<?php echo $oldData[4]; ?>"><br><br>
                            ...
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[6])) . ": "; ?><input type="checkbox" name="<?php echo $columnNames[6]; ?>" <?php if ($oldData[6]) { echo "checked"; } ?>><br><br>
                            <?php echo ucwords(str_replace(array('_', 'id'), array(' ', 'ID'), $columnNames[7])) . ": "; ?><input type="datetime-local" step="1" name="<?php echo $columnNames[7]; ?>" value="<?php echo str_replace(' ', 'T', $oldData[7]); ?>"><br><br>
