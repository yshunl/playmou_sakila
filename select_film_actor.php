...
<div id="page-content-wrapper">
    ...
    <div class="center hideform">
        ...
        <form action="update_film_actor.php" method="POST">
            <h4><b>Update Film Actor</b></h4><hr>
    ...
    <div class="middle hideform">
        ...
        <form action="delete_film_actor.php" method="POST">
            <h4><b>Delete Film Actor</b></h4><hr>
            Actor ID To Delete: <input type="number" name="actor_id"><br><br>
            Film ID To Delete: <input type="number" name="actor_id"><br><br>
    ...
    <div class="mid hideform">
        ...
        <form action="insert_film_actor.php" method="POST">
            <h4><b>Insert New Film Actor</b></h4><hr>
            Actor ID: <input type="number" name="actor_id"><br><br>
    ...
    <table id="_table" width="100%">
        ...
        <?php
            ...
            $sql = "SELECT COUNT(*) AS cntrows FROM film_actor";
            $result = $conn->query($sql);
            $fetchresult = $result->fetch_array();
            $allcount = $fetchresult['cntrows'];
            $sql = "SELECT * FROM film_actor ORDER BY actor_id ASC limit $row,".$rowperpage; // Selecting rows
            $result = $conn->query($sql);
